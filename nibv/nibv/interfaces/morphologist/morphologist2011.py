...
class Morphologist2011InputSpec(CommandLineInputSpec):
    mri = traits.File(
        exists=True,
...
class Morphologist2011OutputSpec(TraitedSpec):
    mri_corrected = traits.File(
        desc='T1 MRI Bias Corrected, Aims writable volume formats')


class Morphologist2011(BVCommand):
    input_spec = Morphologist2011InputSpec
    output_spec = Morphologist2011OutputSpec
    _cmd = 'Morphologist2011'
